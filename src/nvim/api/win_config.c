...
///       Defaults to true. Non-focusable windows are considered to be UI
///       elements which Nvim may treat differently. They can however still be
///       entered by |nvim_set_current_win()|, or, when the `mouse` field is
///       set to true, by mouse events.
